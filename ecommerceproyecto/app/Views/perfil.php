            ...
            <div class="row">
                ...
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6"><label class="labels">Pais</label><input type="text" class="form-control" placeholder="<?php echo $pais; ?>" name="pais" disabled></div>
                            <div class="col-md-6"><label class="labels">Codigo Postal</label><input type="text" class="form-control" name="cod_postal" placeholder="<?php echo $cod_postal; ?>" disabled></div>
                        </div> <br> <br>
                        <div class="mt-5 text-center"><a class="btn btn-primary profile-button" href="edit_perfil.php">Editar Perfil</a></div>
                        <div class="mt-5 text-center"><a class="btn btn-primary profile-button" href="welcome.php">Atrás</a></div>
                    </div>
                </div>

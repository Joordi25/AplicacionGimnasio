...
$sql = "UPDATE users SET nombre = '$nombre', apellidos = '$apellidos', direccion = '$direccion', num_tlf = '$num_tlf', pais = '$pais', cod_postal = '$cod_postal', foto = '$carpeta/$nombre_archivo_con_ext' WHERE username = '$user'";

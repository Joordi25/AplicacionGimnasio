    ...
    <div class="container-fluid">
        ...
        <div id="galeria">
            ...
            <div class="row" style="margin-bottom: 5%;">
                ...
                <div class="col-3">
                    <img class="images" onclick="ampliar2()" id="img2" src="../src/images/galeria/boxed-water-is-better-P4AIjQw1BuY-unsplash.jpg">
                </div>
                <div class="col-3">
            ...
            <div class="row" style="margin-bottom: 5%;">
                ...
                <div class="col-3">
                    <img class="images" onclick="ampliar5()" id="img5" src="../src/images/galeria/gina-lin-m27OTMegUyA-unsplash.jpg">
                </div>
                <div class="col-3">
            ...
            <div class="row" style="margin-bottom: 5%;">
                <div class="col-2"></div>
                <div class="col-3">
                    <img class="images" onclick="ampliar7()" id="img7" src="../src/images/galeria/jelmer-assink-gzeTjGu3b_k-unsplash.jpg">
                </div>
                <div class="col-3">

    ...
    <div class="container-fluid" id="top">
        ...
        <div class="row" id="instalaciones">
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <p id="instalacionesp">Actualmente contamos con unas instalaciones modernas y eficientes, contando con todo el material 
                    para poder llevar acabo entrenos y sesiones programadas y privadas. Disponemos de varias salas de entreno para que nuestros
                    clientes puedan desarrollar sus ejercicios con gran capacidad y de facil accessibilidad. Tambien cabe añadir que tanto zonas de maquinas y 
